...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public void confirm(OrdersConfirmDTO ordersConfirmDTO) {
        // 将状态修改为3  订单状态 1待付款 2待接单 3已接单 4派送中 5已完成 6已取消
...
//                    new BigDecimal(0.01));//原订单金额
            ...
            // 支付状态修改为 退款
            log.info("订单申请退款:{}",ordersRejectionDTO);
...
//                    new BigDecimal(0.01));//原订单金额
            ...
            // 支付状态修改为 退款
            log.info("订单申请退款:{}",ordersCancelDTO);
            orders.setPayStatus(Orders.REFUND);
        }
    ...
    private void checkOutOfRange(String address) {
        ...
        String shopLngLat = (String) ((JSONObject) geocodes.get(0)).get("location");
        ...
        //数据解析
        geocodes = (JSONArray) jsonObject.get("geocodes");
        String userLngLat = (String) ((JSONObject) geocodes.get(0)).get("location");

        map.put("origin",shopLngLat);
        map.put("destination",userLngLat);

        //路线规划
        String json = HttpClientUtil.doGet("https://restapi.amap.com/v5/direction/bicycling?parameters", map);
        ...
        JSONArray jsonArray = (JSONArray) result.get("paths");
        String distance = (String) ((JSONObject) jsonArray.get(0)).get("distance");
